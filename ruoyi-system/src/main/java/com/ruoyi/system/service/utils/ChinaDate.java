...
public class ChinaDate {
     ...
     * @throws Exception
     */
    public static String solarToLunar(String solarDate, Boolean isFormat) throws Exception{
        int i;
        int temp = 0;
        int lunarYear;
        int lunarMonth; //农历月份
    ...
    public static void main(String[] args) throws Exception {
        StringBuilder stringBuilder = new StringBuilder("20200824");
        System.out.println(ChinaDate.lunarToSolar(stringBuilder.toString(), false));
        //System.out.println(ChinaDate.solarToLunar("2020-08-24",false));
